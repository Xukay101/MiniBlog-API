...
Revision ID: 57eac8cb9eb3
Revises: 
Create Date: 2023-10-31 21:09:01.956019
...
def upgrade():
    ...
    sa.Column('content', sa.Text(), nullable=False),
    sa.Column('user_id', sa.BINARY(length=16), nullable=False),
    sa.Column('post_id', sa.BINARY(length=16), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    ...
    sa.Column('post_id', sa.BINARY(length=16), nullable=False),
    sa.Column('category_id', sa.BINARY(length=16), nullable=False),
